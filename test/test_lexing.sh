...
export COMMAND="\${"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 1, char 1: \${
                                                 ^^
"
run_test
...
export COMMAND="echo abc\${def"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 1, char 9: ...o abc\${def
                                                         ^^
"
run_test
...
export COMMAND="ls a\${bcd"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 1, char 5: ls a\${bcd
                                                     ^^
"
run_test
...
export COMMAND="echo a\${bcdefg"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 1, char 7: ...cho a\${bcdef...
                                                         ^^
"
run_test
...
export COMMAND="calabash ab\${cdefg"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 1, char 12: ...sh ab\${cdefg
                                                          ^^
"
run_test
...
export COMMAND="echo qwertyuiop\${asdfghjkl"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 1, char 16: ...yuiop\${asdfg...
                                                          ^^
"
run_test
...
poiuytrewq"
export EXPECTED_RESULT="\
../calabash: unclosed brace near line 2, char 12: ...m'mnb\${lkj
                                                          ^^
"
run_test
