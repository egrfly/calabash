...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   try_get_simple_command_core_and_suffix.c           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
static const
	t_parsing_option
	g_core_with_suffix_sequence[] = {
{
	.token_consumption_func = try_get_simple_command_core,
...
static const
	t_parsing_option_sequence_with_count
	*g_simple_command_core_and_suffix_sequences[] = {
	&g_core_with_suffix_sequence_with_count,
	NULL,
};
