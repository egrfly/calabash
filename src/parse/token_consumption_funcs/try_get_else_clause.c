...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   try_get_else_clause.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: emflynn <emflynn@student.42london.com>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/02/13 19:59:07 by emflynn           #+#    #+#             */
/*   Updated: 2025/02/26 14:03:54 by emflynn          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const
	t_parsing_option
	g_keyword_with_body_sequence[] = {
{
	.token_consumption_func = try_get_reserved_word,
	.token_consumption_func_arg = "else",
...
static const
	...
	g_keyword_with_body_sequence_with_count = {
	.name = "keyword with body",
	.sequence = g_keyword_with_body_sequence,
	.count = sizeof(g_keyword_with_body_sequence)
	/ sizeof(t_parsing_option),
};

static const
	t_parsing_option_sequence_with_count
	*g_else_clause_sequences[] = {
	&g_keyword_with_body_sequence_with_count,
	NULL,
};
